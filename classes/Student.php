    ...
    class Student {
        ...
        public static function getStudent($connection, $id, $columns = "*") {
            ...
            try {
                ...
                error_log("Chyba u funce getStudent, získání dat selhalo\n", 3, "../errors/error.log");
        ...
        public static function updateStudent($connection, $first_name, $second_name, $age, $life, $college, $id){
            ...
            try {
                ...
                error_log("Chyba u funce updateStudent, update student se nepovedl\n", 3, "../errors/error.log");
                echo "Chyba: " . $e->getMessage();
            }
        }
        ...
        public static function deleteStudent($connection, $id){
            ...
            try {
                ...
                error_log("Chyba u funce deleteStudent, delete student se nepovedl\n", 3, "../errors/error.log");
                echo "Chyba: " . $e->getMessage();
            }
        }
        ...
        public static function getAllStudents($connection, $columns = "*"){
            ...
            try {
                ...
                error_log("Chyba u funce getAllStudents, get all students se nepovedl\n", 3, "../errors/error.log");
                echo "Chyba: " . $e->getMessage();
            }
        }
        ...
        public static function createStudent($connection, $first_name, $second_name, $age, $life, $college) {
            ...
            try {
                ...
                error_log("Chyba u funce createStudent, create student se nepovedl\n", 3, "../errors/error.log");
                echo "Chyba: " . $e->getMessage();
            }
        }
    }
